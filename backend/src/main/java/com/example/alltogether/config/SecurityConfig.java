    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, UserDetailsService userDetailsService) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Images: GET public, POST/DELETE nécessite authentification
                        .requestMatchers(HttpMethod.GET, "/api/images/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/images/user/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/images/user/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/images/place/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/images/places/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/images/place/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/images/city/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/images/city/**").hasRole("ADMIN")
